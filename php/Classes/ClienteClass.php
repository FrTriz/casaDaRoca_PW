...
public function atualizarDados($id_cliente, $nome, $rua, $numero, $cidade, $estado, $cep, $telefone) {
    $sql = "UPDATE Cliente 
            SET nome = :nome, rua = :rua, numero = :numero, cidade = :cidade, estado = :estado, cep = :cep, telefone = :telefone 
            WHERE id_cliente = :id";
